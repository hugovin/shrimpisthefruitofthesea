<%@ Page Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="500.aspx.cs" Inherits="_500" Title="Untitled Page" %>
                    ...
                    <div>
                        <div class="boxURLRequested">
                            ...
                            <div class="mainURLRequested">
                                ...
                                <p>Please it tries again in minutes</p></div>
                            </div>
