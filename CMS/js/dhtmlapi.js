...
function save_hour_hidden_from(valueTest){
    var myValue = valueTest.value;
    document.getElementById("hidden_from_hour").value=myValue;
}

function save_minute_hidden_from(valueTest){
    var myValue = valueTest.value;
    document.getElementById("hidden_from_minute").value=myValue;
    //alert(myValue);
}

function save_ampm_hidden_from(valueTest){
    var myValue = valueTest.value;
    document.getElementById("hidden_from_ampm").value=myValue;
}

function save_hour_hidden_to(valueTest){
    var myValue = valueTest.value;
    document.getElementById("hidden_to_hour").value=myValue;
}

function save_minute_hidden_to(valueTest){
    var myValue = valueTest.value;
    document.getElementById("hidden_to_minute").value=myValue;
}

function save_amppm_hidden_to(valueTest){
    var myValue = valueTest.value;
    document.getElementById("hidden_to_ampm").value=myValue;
}
