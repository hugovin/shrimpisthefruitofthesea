...
var multiBox = new Class({
	...
	options:{
		...
		movieSize: {w:560, h:300},//default width/height of movie
	...
	start: function(){
		...
		this.controlEffects = new Fx.Morph(this.controlsContainer,{duration:400});
		this.reset();
	},
	...
	open: function(index,currGal){
		...
		if(!this.opened){
			...
			this.timer = this.hideContent.bind(this).delay(400);
	...
	close: function(){
		...
		this.zoomOut.bind(this).delay(400);
	...
	zoomOut: function(){
		...
		this.reset.bind(this).delay(400);
	},
	...
	resize: function(){
		...
		this.timer = this.showContent.bind(this).delay(400);
	},
	...
	hideContent: function(){
		...
		this.removeContent.bind(this).delay(400);
	},
		...
		if(this.container.getStyle('height') != 'auto'){
			...
			if(this.options.recalcTop == true){
				if(this.container.getStyle('top').toInt() > this.controls.getStyle('height').toInt()/2){
					this.finalResize = new Fx.Morph(this.container,{duration:10});
		...
		chainArray.each(function(el,i){
			...
			if(el.getElement('img')){
				...
				var hoverOn = function(){
					el.getElement('img').set('tween',{duration:400,transition:Fx.Transitions.linear}).tween('opacity',0.5);
				};
