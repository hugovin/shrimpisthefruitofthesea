	...
	initialize: function(container, images, options){
		...
		if($type(images) == 'string' && !this.options.thumbnails){
			...
			if(this.options.backgroundSlider){
				this.bgSlider = new BackgroundSlider(this.thumbnailImages,{mouseOver: false, duration: this.options.duration, className: this.options.thumbnailCls, padding:{top:0,right:-8,bottom:-8,left:0}});
