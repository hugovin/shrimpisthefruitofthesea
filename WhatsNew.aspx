<%@ Page Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="WhatsNew.aspx.cs" Inherits="WhatsNew" Title="Untitled Page" %>
...
<!-- Cart Code --> 
    <div id="cont">   
        <div id="print">
            <asp:PlaceHolder ID="PlaceHolder_WhatsNew" runat="server"></asp:PlaceHolder> 
        </div>         	
    </div>
</asp:Content>
