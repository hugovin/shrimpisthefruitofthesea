<%@ Page Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="Generic_b.aspx.cs" Inherits="Generic_b" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HomeContent_Master" Runat="Server">
    <div id="cont">
        <div id="print">
            <div class="wysiwig">
                <asp:PlaceHolder ID="PlaceHolder_Generic_B" runat="server"></asp:PlaceHolder>
            </div> 
        </div>       
