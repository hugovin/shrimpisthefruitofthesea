<%@ Page Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="genTemB.aspx.cs" Inherits="genTemB" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HomeContent_Master" Runat="Server">
    <div id="cont">
        <div id="print">
            <div class="wysiwig">
                <asp:PlaceHolder ID="PlaceHolder_GenTem_B" runat="server"></asp:PlaceHolder> 
            </div>
        </div>     
